...
// Функцията, която искате да се изпълнява
function myTask() {
  setup();
}

// Задаване на интервала: 60 секунди * 1000 милисекунди
const ONE_MINUTE_IN_MS = 30 * 1000;

// Стартиране на повторението през 1 минута
const intervalId = setInterval(myTask, ONE_MINUTE_IN_MS);
